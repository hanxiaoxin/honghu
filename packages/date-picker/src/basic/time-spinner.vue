<template>
  <div class="hu-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <hu-scrollbar
        @mouseenter.native="emitSelectRange('hours')"
        @mousemove.native="adjustCurrentSpinner('hours')"
        class="hu-time-spinner__wrapper"
        wrap-style="max-height: inherit;"
        view-class="hu-time-spinner__list"
        noresize
        tag="ul"
        ref="hours">
        <li
    ...
    <template v-if="arrowControl">
      <div
        ...
        class="hu-time-spinner__wrapper is-arrow">
        <i v-repeat-click="decrease" class="hu-time-spinner__arrow hu-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="hu-time-spinner__arrow hu-icon-arrow-down"></i>
        <ul class="hu-time-spinner__list" ref="hours">
          <li
            class="hu-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="hu-time-spinner__arrow hu-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="hu-time-spinner__arrow hu-icon-arrow-down"></i>
        <ul class="hu-time-spinner__list" ref="minutes">
          <li
            class="hu-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="hu-time-spinner__arrow hu-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="hu-time-spinner__arrow hu-icon-arrow-down"></i>
        <ul class="hu-time-spinner__list" ref="seconds">
          <li
...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'honghu-ui/src/utils/date-util';
