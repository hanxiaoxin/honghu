<template>
  <transition name="hu-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="hu-time-panel hu-popper"
      :class="popperClass">
      <div class="hu-time-panel__content" :class="{ 'has-seconds': showSeconds }">
        <time-spinner
          ref="spinner"
          @change="handleChange"
...
<script type="text/babel">
  import { limitTimeRange, isDate, clearMilliseconds, timeWithinRange } from 'honghu-ui/src/utils/date-util';
