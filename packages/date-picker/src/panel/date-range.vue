<template>
  <transition name="hu-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="hu-picker-panel hu-date-range-picker hu-popper"
      :class="[{
      ...
      <div class="hu-picker-panel__body-wrapper">
        ...
        <div class="hu-picker-panel__body">
          <div class="hu-date-range-picker__time-header" v-if="showTime">
            <span class="hu-date-range-picker__editors-wrap">
              <span class="hu-date-range-picker__time-picker-wrap">
                <hu-input
                  size="small"
                  :disabled="rangeState.selecting"
                  ref="minInput"
                  :placeholder="t('el.datepicker.startDate')"
                  class="hu-date-range-picker__editor"
                  :value="minVisibleDate"
                  @input="val => handleDateInput(val, 'min')"
                  @change="val => handleDateChange(val, 'min')" />
              </span>
              <span class="hu-date-range-picker__time-picker-wrap" v-clickoutside="handleMinTimeClose">
                <hu-input
                  size="small"
                  class="hu-date-range-picker__editor"
                  :disabled="rangeState.selecting"
            ...
            <span class="hu-icon-arrow-right"></span>
            <span class="hu-date-range-picker__editors-wrap is-right">
              <span class="hu-date-range-picker__time-picker-wrap">
                <hu-input
                  size="small"
                  class="hu-date-range-picker__editor"
              ...
              <span class="hu-date-range-picker__time-picker-wrap" v-clickoutside="handleMaxTimeClose">
                <hu-input
                  size="small"
                  class="hu-date-range-picker__editor"
                  :disabled="rangeState.selecting"
          ...
          <div class="hu-picker-panel__content hu-date-range-picker__content is-left">
            <div class="hu-date-range-picker__header">
              <button
                type="button"
                @click="leftPrevYear"
                class="hu-picker-panel__icon-btn hu-icon-d-arrow-left"></button>
              <button
                type="button"
                @click="leftPrevMonth"
                class="hu-picker-panel__icon-btn hu-icon-arrow-left"></button>
              <button
                type="button"
                @click="leftNextYear"
                v-if="unlinkPanels"
                ...
                class="hu-picker-panel__icon-btn hu-icon-d-arrow-right"></button>
              <button
                type="button"
                @click="leftNextMonth"
                v-if="unlinkPanels"
                ...
                class="hu-picker-panel__icon-btn hu-icon-arrow-right"></button>
              <div>{{ leftLabel }}</div>
            </div>
            <date-table
          ...
          <div class="hu-picker-panel__content hu-date-range-picker__content is-right">
            <div class="hu-date-range-picker__header">
              <button
                type="button"
                @click="rightPrevYear"
      ...
      <div class="hu-picker-panel__footer" v-if="showTime">
        <hu-button
          size="mini"
          type="text"
