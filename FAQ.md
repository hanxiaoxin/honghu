...
<details>
  ...
  ```html
  <hu-button @click="handleButtonClick">Click Me</hu-button>
  ```
...
<details>
  ...
  <hu-table-column label="操作">
    <template slot-scope="props">
      <hu-button @click.native="showDetail(props.row)">查看详情</hu-button>
    </template>
  </hu-table-column>
  ```
  参数 `row` 即为对应行的数据。
...
<details>
  ...
  <hu-table-column label="Operations">
    <template slot-scope="props">
      <hu-button @click.native="showDetail(props.row)">Details</hu-button>
    </template>
  </hu-table-column>
  ```
...
<details>
  ...
  ```html
  <hu-button @click="handleButtonClick">Haga Clic Aquí</hu-button>
  ```
...
<details>
  ...
  <hu-table-column label="Operaciones">
    <template slot-scope="props">
      <hu-button @click.native="verDetalles(props.row)">Detalles</hu-button>
    </template>
  </hu-table-column>
  ```
