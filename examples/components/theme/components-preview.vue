...
<template>
  <div class="component-preview">
    ...
    <h4>Table</h4>
    <hu-row>
      <hu-table :data="tableData" style="width: 70%">
        <hu-table-column prop="date" label="Date" width="180"></hu-table-column>
        <hu-table-column prop="name" label="Name" width="180"></hu-table-column>
        <hu-table-column prop="address" label="Address"></hu-table-column>
      </hu-table>
    </hu-row>
    <h4>Tag</h4>
    <hu-row>
    ...
    <h4>Loading</h4>
    <hu-row>
      <hu-table :data="tableData" style="width: 90%" v-loading="true">
        <hu-table-column prop="date" label="Date" width="180"></hu-table-column>
        <hu-table-column prop="name" label="Name" width="180"></hu-table-column>
        <hu-table-column prop="address" label="Address"></hu-table-column>
      </hu-table>
    ...
    <h4>Menu</h4>
    <hu-row>
      <hu-menu :default-active="menu" class="hu-menu-demo" mode="horizontal">
    ...
    <h4>Collapse</h4>
    <hu-row>
      <hu-collapse v-model="collapse">
        <hu-collapse-item title="Consistent" name="1">
