...
```html
<template>
  <hu-transfer v-model="value" :data="data"></hu-transfer>
</template>
...
<template>
  ...
  <div style="text-align: center">
    <hu-transfer
      ...
      @change="handleChange"
      :data="data">
      <hu-button class="transfer-footer" slot="left-footer" size="small">操作</hu-button>
      <hu-button class="transfer-footer" slot="right-footer" size="small">操作</hu-button>
    </hu-transfer>
  </div>
