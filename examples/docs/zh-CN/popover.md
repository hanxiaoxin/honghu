...
<template>
  <hu-popover
    ...
    <hu-button slot="reference">hover 激活</hu-button>
  </hu-popover>
  ...
  <hu-button v-popover:popover>focus 激活</hu-button>
  ...
  <hu-popover
    ...
    content="这是一段内容,这是一段内容,这是一段内容,这是一段内容。"
    v-model="visible">
    <hu-button slot="reference" @click="visible = !visible">手动激活</hu-button>
  </hu-popover>
</template>
...
<hu-popover
  ...
  <div style="text-align: right; margin: 0">
    <hu-button size="mini" type="text" @click="visible = false">取消</hu-button>
    <hu-button type="primary" size="mini" @click="visible = false">确定</hu-button>
  </div>
  <hu-button slot="reference">删除</hu-button>
</hu-popover>
