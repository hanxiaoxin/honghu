...
<div class="block">
  ...
  <hu-cascader
    v-model="value"
    :options="options"
    @change="handleChange"></hu-cascader>
</div>
<div class="block">
...
```html
<hu-cascader :options="options"></hu-cascader>
...
:::demo
```html
<hu-cascader :options="options" clearable></hu-cascader>
...
```html
<hu-cascader :options="options" :show-all-levels="false"></hu-cascader>
...
```html
<hu-cascader :props="props"></hu-cascader>
...
```html
<hu-cascader-panel :options="options"></hu-cascader-panel>
