...
describe('Radio', () => {
  ...
  it('create', done => {
    vm = createVue({
      template: `
        <hu-radio v-model="radio" label="a">
        </hu-radio>
      `,
      data() {
        return {
    ...
    let radioElm = vm.$el;
    expect(radioElm.classList.contains('hu-radio')).to.be.true;
    radioElm.click();
    setTimeout(_ => {
  ...
  describe('Radio group', () => {
      ...
      vm = createVue({
        template: `
          <hu-radio-group v-model="radio">
            <hu-radio :label="3" ref="radio1">备选项</hu-radio>
            <hu-radio :label="6" ref="radio2">备选项</hu-radio>
    ...
    it('disabled', done => {
      vm = createVue({
        template: `
          <hu-radio-group v-model="radio" disabled>
            <hu-radio :label="3" ref="radio1">备选项</hu-radio>
            <hu-radio :label="6" ref="radio2">备选项</hu-radio>
            <hu-radio :label="9">备选项</hu-radio>
          </hu-radio-group>
    ...
    it('change event', done => {
      vm = createVue({
        template: `
          <hu-radio-group v-model="radio" @change="onChange">
    ...
    it('disabled when children is radio button', done => {
      vm = createVue({
        template: `
          <hu-radio-group v-model="radio" disabled>
            <hu-radio-button :label="3" ref="radio1">备选项</hu-radio-button>
            <hu-radio-button :label="6" ref="radio2">备选项</hu-radio-button>
            <hu-radio-button :label="9">备选项</hu-radio-button>
          </hu-radio-group>
        `,
        data() {
          return {
    ...
    it('keyboard event', done => {
      vm = createVue({
        template: `
          <hu-radio-group v-model="radio">
            <hu-radio-button ref="radio1" :label="3">备选项</hu-radio-button>
            <hu-radio-button ref="radio2" :label="6">备选项</hu-radio-button>
            <hu-radio-button ref="radio3" :label="9">备选项</hu-radio-button>
          </hu-radio-group>
        `,
        data() {
          return {
    ...
    describe('Radio Button', () => {
      ...
      it('custom color', done => {
        vm = createVue({
          template: `
            <hu-radio-group v-model="radio" fill="#000" text-color="#ff0">
              <hu-radio-button :label="3" ref="radio1">备选项</hu-radio-button>
              <hu-radio-button :label="6" ref="radio2">备选项</hu-radio-button>
              <hu-radio-button :label="9">备选项</hu-radio-button>
            </hu-radio-group>
      ...
      it('change event', done => {
        vm = createVue({
          template: `
            <hu-radio-group v-model="radio" @change="onChange">
              <hu-radio-button :label="3">备选项</hu-radio-button>
              <hu-radio-button :label="6" ref="radio2">备选项</hu-radio-button>
              <hu-radio-button :label="9">备选项</hu-radio-button>
            </hu-radio-group>
          `,
      ...
      it('size', done => {
        vm = createVue({
          template: `
            <hu-radio-group v-model="radio" size="large">
              <hu-radio-button :label="3" ref="radio1">备选项</hu-radio-button>
              <hu-radio-button :label="6" ref="radio2">备选项</hu-radio-button>
              <hu-radio-button :label="9">备选项</hu-radio-button>
            </hu-radio-group>
        ...
        setTimeout(_ => {
          expect(vm.$el.querySelectorAll('.hu-radio-button--large').length).to.be.equal(3);
          done();
        }, 10);
      });
    });
